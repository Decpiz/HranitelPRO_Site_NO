...
namespace PR_21._106_HranitelPRO_Practic.Model
{
    ...
    public partial class HranitelPRO : DbContext
    {
        private static HranitelPRO instance;
        public HranitelPRO()
            : base("name=HranitelPRO")
        {
        }
        ...
        public static HranitelPRO GetContext()
        {
            if (instance == null)
                instance = new HranitelPRO();
            return instance;
        }
